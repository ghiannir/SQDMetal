...
## Customized part
    def import_parameters(self, param_file="mph/Al_params.txt"):
        model = self._model.java
        model.param().loadFile(param_file)

    def redefine_geometry(self, chip_dim_x="0.003", chip_dim_y="0.003"):
        model = self._model.java
        model.component("comp1").geom("geom1").feature("blk_chip").set("size", jtypes.JArray(jtypes.JString)([chip_dim_x, chip_dim_y, "t_sub"]))
        model.component("comp1").geom("geom1").feature("blk_chip").set("pos", jtypes.JArray(jtypes.JString)(["0", "0", "-t_sub/2"]))
        model.component("comp1").geom("geom1").feature("blk_boundary").set("size", jtypes.JArray(jtypes.JString)([chip_dim_x, chip_dim_y, "t_air"]))
        model.component("comp1").geom("geom1").feature("blk_boundary").set("pos", jtypes.JArray(jtypes.JString)(["0", "0", "t_air/2"]))
        model.component("comp1").geom("geom1").runPre("fin")
        model.component("comp1").geom("geom1").run("selFused1")
        ...
        model.component("comp1").geom("geom1").feature("difsel1").set("entitydim", jtypes.JInt(2))
        model.component("comp1").geom("geom1").feature("difsel1").set("add", jtypes.JArray(jtypes.JString)(["wp1_selcond0"]))
        model.component("comp1").geom("geom1").feature("difsel1").set("subtract", jtypes.JArray(jtypes.JString)(["selFused0", "selFused1"]))
        model.component("comp1").geom("geom1").runPre("fin")
        model.component("comp1").geom("geom1").feature("difsel1").set("entitydim", jtypes.JInt(3))
        model.component("comp1").geom("geom1").runPre("fin")
        model.component("comp1").geom("geom1").feature("difsel1").set("entitydim", jtypes.JInt(2))
        model.component("comp1").geom("geom1").runPre("fin")
        ...
        model.component("comp1").geom("geom1").feature("unisel1").label("condAll")
        model.component("comp1").geom("geom1").feature("unisel1").set("entitydim", jtypes.JInt(2))
        model.component("comp1").geom("geom1").feature("unisel1").set("input", jtypes.JArray(jtypes.JString)(["selFused0", "selFused1"]))
        model.component("comp1").geom("geom1").runPre("difsel1")
        model.component("comp1").geom("geom1").feature("wp1").geom().run("difGND")
        model.component("comp1").geom("geom1").feature("wp1").geom().create("r1", "Rectangle")
        model.component("comp1").geom("geom1").feature("wp1").geom().feature("r1").set("size", jtypes.JArray(jtypes.JString)([chip_dim_x, chip_dim_y]))
        model.component("comp1").geom("geom1").feature("wp1").geom().feature("r1").set("base", "center")
        model.component("comp1").geom("geom1").feature("wp1").geom().feature("r1").set("pos", jtypes.JArray(jtypes.JInt)([0, 0]))
        model.component("comp1").geom("geom1").feature("wp1").geom().run("r1")
        model.component("comp1").geom("geom1").feature("wp1").geom().create("sel1", "ExplicitSelection")
        model.component("comp1").geom("geom1").feature("wp1").geom().feature("sel1").selection("selection").set("r1", 1)
        model.component("comp1").geom("geom1").runPre("difsel1")
        model.component("comp1").geom("geom1").feature("difsel1").set("add", jtypes.JArray(jtypes.JString)(["wp1_sel1"]))
        model.component("comp1").geom("geom1").feature("difsel1").set("subtract", jtypes.JArray(jtypes.JString)(["unisel1"]))
        model.component("comp1").geom("geom1").runPre("fin")
        model.component("comp1").geom("geom1").run()

    def set_materials_physics(self):
        model = self._model.java
        self._create_material('Vacuum', 1.0, 1.0, 0.0)
        model.component("comp1").material('Vacuum').selection().all()
        self._create_material('Substrate', 0.0, 1.0, 0.0)
        self._create_material('Metal', 0.0, 1.0, 3.77e7)
        model.component("comp1").material("Substrate").selection().set(jtypes.JInt(1))
        model.component("comp1").material("Metal").selection().set(jtypes.JArray(jtypes.JInt)([2,4]))
        model.component("comp1").material("Substrate").propertyGroup("def").set("relpermittivity", jtypes.JArray(jtypes.JString)(["eps_Si"]))
        model.component("comp1").material("Metal").propertyGroup("def").set("electricconductivity", jtypes.JArray(jtypes.JString)(["-1j*alpha/emw.freq"]))
    ...
    def mesh(self):
        ...
        model.component("comp1").mesh("mesh1").feature("ftri1").selection().set(9, 17, 22)
        model.component("comp1").mesh("mesh1").feature("ftri1").create("size1", "Size")
        model.component("comp1").mesh("mesh1").feature("ftri1").feature("size1").set("hauto",jtypes.JInt(1))
        model.component("comp1").mesh("mesh1").feature("ftri1").feature("size1").set("custom", True)
        model.component("comp1").mesh("mesh1").feature("ftri1").feature("size1").set("hmaxactive", True)
        model.component("comp1").mesh("mesh1").feature("ftri1").feature("size1").set("hmax", 6.0E-4)
        ...
        model.component("comp1").mesh("mesh1").feature("swe1").selection().geom("geom1", jtypes.JInt(3))
        model.component("comp1").mesh("mesh1").feature("swe1").selection().set(2, 4, 5)
        model.component("comp1").mesh("mesh1").feature("swe1").selection("sourceface").set(9, 17, 22)
        model.component("comp1").mesh("mesh1").feature("swe1").selection("targetface").set(6, 16, 21)
        model.component("comp1").mesh("mesh1").feature("swe1").create("dis1", "Distribution")
        model.component("comp1").mesh("mesh1").feature("swe1").feature("dis1").set("numelem", jtypes.JInt(1))
        model.component("comp1").mesh("mesh1").create("ftet1", "FreeTet")
        model.component("comp1").mesh("mesh1").feature("ftet1").selection().geom("geom1", jtypes.JInt(3))
        model.component("comp1").mesh("mesh1").feature("ftet1").selection().set(jtypes.JInt(3))
        model.component("comp1").mesh("mesh1").feature().duplicate("ftet2", "ftet1")
        model.component("comp1").mesh("mesh1").feature("ftet2").selection().set(jtypes.JInt(1))
        model.component("comp1").mesh("mesh1").feature("ftet2").selection().remaining()
        model.component("comp1").mesh("mesh1").run()

    def setup_study(self, search_around_freq_GHz="3", linearization_freq_GHz="4"):
        model = self._model.java
        ...
        model.study("std1").feature("eig").set("neigs", jtypes.JInt(1))
        model.study("std1").feature("eig").set("eigwhich", "lr")
        model.sol().create("sol1")
        model.sol("sol1").study("std1")
        model.study("std1").feature("eig").set("notlistsolnum", jtypes.JInt(1))
        model.study("std1").feature("eig").set("notsolnum", "auto")
        model.study("std1").feature("eig").set("listsolnum", jtypes.JInt(1))
        model.study("std1").feature("eig").set("solnum", "auto")
        model.study("std1").feature("eig").set("linplistsolnum", jtypes.JArray(jtypes.JString)(["1"]))
        model.study("std1").feature("eig").set("linpsolnum", "auto")
        model.study("std1").feature("eig").set("shift", jtypes.JString(f"{search_around_freq_GHz}[GHz]"))
        ...
        model.sol("sol1").feature("e1").feature("i1").feature("mg1").feature("pr").feature("sv1").set("iter", jtypes.JInt(2))
        model.sol("sol1").feature("e1").feature("i1").feature("mg1").feature("pr").feature("sv1").set("relax", jtypes.JInt(1))
        model.sol("sol1").feature("e1").feature("i1").feature("mg1").feature("pr").feature("sv1").set("sorvecdof", jtypes.JArray(jtypes.JString)(["comp1_E"]))
        ...
        model.sol("sol1").feature("e1").feature("i1").feature("mg1").feature("po").feature("sv1").set("iter", jtypes.JInt(2))
        model.sol("sol1").feature("e1").feature("i1").feature("mg1").feature("po").feature("sv1").set("relax", jtypes.JInt(1))
        model.sol("sol1").feature("e1").feature("i1").feature("mg1").feature("po").feature("sv1").set("sorvecdof", jtypes.JArray(jtypes.JString)(["comp1_E"]))
        ...
        model.sol("sol1").feature("e1").set("eigref", linearization_freq_GHz)
    ...
    def run(self):
        ...
        model.result().numerical("gev1").set("expr", jtypes.JArray(jtypes.JString)(["emw.freq", "emw.Qfactor"]))
        model.result().numerical("gev1").set("unit", jtypes.JArray(jtypes.JString)(["GHz", "1"]))
        ...
        data = model.result().numerical("gev1").getReal()  # oppure getData(), dipende dalla versione COMSOL
    ...
    def plot_results(self):
        ...
        model.result("pg1").feature("mslc1").set("zcoord", jtypes.JInt(0))
        model.result("pg1").feature("mslc1").set("colortable", "ThermalWaveDark")
        model.result("pg1").feature("mslc1").create("def1", "Deform")
        model.result("pg1").run()
        model.result("pg1").feature("mslc1").feature("def1").set("expr", jtypes.JArray(jtypes.JString)(["0", "0", "emw.normE"]))
        model.result("pg1").run()
